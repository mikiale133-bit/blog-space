...
const TeacherSidebar = () => {
  ...
  return (
    <div className="min-w-64 bg-white border-r border-border dark:border-none dark:bg-muted/50 p-4 h-screen sticky top-0 flex flex-col justify-between">
      {/* Sidebar Header Brand Identity */}
      <div className="flex items-center gap-2 px-2 py-4 mb-4 border-b border-[var(--border-muted)]">
