...
// // Helper to extract file data from existing resource
// const extractFileData = (fileObj) => {
//   if (!fileObj || !fileObj.url) return [];
//   return [
//     {
//       id: fileObj.public_id || fileObj._id,
//       name: fileObj.metadata?.originalName || "File",
//       url: fileObj.url,
//       size: fileObj.metadata?.sizeInBytes || 0,
//       type: fileObj.metadata?.mimeType || "application/octet-stream",
//     },
//   ];
// };

const ResourceForm = ({ topicId, subjectId, chapterId, setUploadModal }) => {
          ...
          >
            {submitting ? (
              ...
              <>
                ...
                {topicId ? "Update Resource" : "Create Resource"}
              </>
            )}
          </button>
        </div>
