  ...
  return (
    <div className="min-h-screen text-[#001e00]">
      ...
      <main className="max-w-5xl mx-auto px-1 py-2 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-0 rounded-2xl bg-white overflow-hidden md:px-8">
          {/* Main Content Column */}
          <div className="lg:col-span-3 lg:border-r border-slate-200">
            ...
            <section className="p-8 pt-0">
              <h3 className="text-base font-medium mb-4">Feed Category</h3>
          ...
          {/* Right Sidebar */}
          <div className="lg:col-span-1 bg-white p-6 space-y-8">
            ...
            <div className="pt-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-[15px]">{post.user.name}</p>
